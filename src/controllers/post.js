...
var PostController = /** @class */ (function () {
    ...
    PostController.prototype.createPost = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var postInfo, newPost;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        postInfo = __assign({}, req.body);
                        return [4 /*yield*/, this.postService.createPost(postInfo)];
                    case 1:
                        newPost = _a.sent();
                        req.flash('success', '포스트 등록 완료!');
                        return [2 /*return*/, res.status(201).json(newPost.id)];
                }
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        id = req.params.id;
                        return [4 /*yield*/, this.postService.updatePost(id, __assign({}, req.body))];
                    case 1:
                        post = _a.sent();
...
// };
var postController = new PostController(post_1.postService);
